...
public abstract class InteractionController : MonoBehaviour
{
    ...
    // ¬ÒÂ ‡ÍÚË‚Ì˚Â InteractionController
...
public abstract class InteractionController : MonoBehaviour
{
    ...
    {
        // UnityEngine.Debug.Log($"Õ‡Ê‡Ú‡ F - {mainController.list_of_interactable_objects_names[mainController.scrollInteractionScript.current_index]}, {mainController.scrollInteractionScript.current_index}");
