...
public abstract class InteractionController : MonoBehaviour
{
    ...
    {
        // UnityEngine.Debug.Log($"Ќажата F - {mainController.list_of_interactable_objects_names[mainController.scrollInteractionScript.current_index]}, {mainController.scrollInteractionScript.current_index}");
